...
|            | Pros                                             | Cons                                                                                                            |
| ---------- | ------------------------------------------------ | --------------------------------------------------------------------------------------------------------------- |
| **Census** | - Gives fully **accurate** results               | - Time consuming<br>- Expensive to run<br>- Impractical<br>- May destroy elements (testing single-use machines) |
| **Sample** | - Quicker<br>- Cheaper<br>- Less data to analyze | - May not be representative of the population                                                                   |
...
>
> Elements are chosen from the sample using **simple random sampling** from **each strata** in the population
> - Number of elements can **be or not be** corresponded to the **proportion** of the population in that stratum
...
>
> Then a simple random sample is used to randomly select one ore more clusters out of the possible clusters
> - All elements in the **selected clusters** are used in the sample
