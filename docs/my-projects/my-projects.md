...
![LexiGen](https://github.com/gitmichaelqiu/LexiGen/blob/main/Lexi.png?raw=true)
...
<video width="100%" controls>
  <source src="../LexiGenDemo.mp4" type="video/mp4">
...
[Ollama Writing Tools](https://github.com/gitmichaelqiu/OllamaWritingTools), under [Apache-2.0 license](https://github.com/gitmichaelqiu/OllamaWritingTools/blob/main/LICENSE), is a Windows application that enhances your writing with AI-powered assistance through Ollama. Simply select text anywhere, and get instant writing improvements with a single click. It is 100% free and open source, and even customizable, you can configure different prompts for different writing tasks.
...
![MoA-Ollama-Chat](https://github.com/gitmichaelqiu/MoA-Ollama-Chat/blob/main/assets/whitetheme.png?raw=true)

[MoA-Ollama-Chat](https://github.com/gitmichaelqiu/MoA-Ollama-Chat), forked from [severian42/MoA-Ollama-Chat](https://github.com/severian42/MoA-Ollama-Chat).

The improved UI version of the chat interface for [severian42/MoA-Ollama-Chat](https://github.com/severian42/MoA-Ollama-Chat).
